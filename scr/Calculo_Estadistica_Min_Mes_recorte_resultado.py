...
folder = '/home/alighezzolo/BTCH13/OUTPUTS/NC/'+dia+'/minima/' ###acceso al .nc
...
archiM='/home/alighezzolo/BTCH13/OUTPUTS/NC/'+dia+'/minima/Minima_'+dia+'.txt'
arch = open (archiM,'r')
...
connectionInfo_0 = 'HDF5:\"' + folder+'Minima_'+dia+'.nc' + '\"://'+VAR
...
bmap.readshapefile(dires+'DEPARTAMENTOS_linea','DEPARTAMENTOS_linea',linewidth=0.2,color='grey')#bmap.readshapefile(dires3+'Límites_internacionales','Límites_internacionales',linewidth=0.3,color='w')
...
img_plot=bmap.imshow(array_01-273.15, origin='upper', cmap='RdYlBu', vmin=-100, vmax=-20)#spectral

...
folder2 =  '/home/alighezzolo/BTCH13/DATA/'+dia+'/' ### a las imagens origen

folder = '/home/alighezzolo/BTCH13/OUTPUTS/NC/'+dia+'/frecuencia_diaria/'####al .nc de frecuencia
...
archiM='/home/alighezzolo/BTCH13/OUTPUTS/NC/'+dia+'/frecuencia_diaria/frecuencia_d_'+dia+'_'+str(umbral)+'K_FD.txt'
arch = open (archiM,'r')
...
connectionInfo_0 = 'HDF5:\"' + folder+'frecuencia_d_'+dia+'_'+str(umbral)+'K_FD.nc' + '\"://'+VAR #####CAMBIAR ACA!!
...
array_01 = array_01*0.25 #* scale + offset 
...
bmap.readshapefile(dires+'DEPARTAMENTOS_linea','DEPARTAMENTOS_linea',linewidth=0.2,color='gray')#bmap.readshapefile(dires3+'Límites_internacionales','Límites_internacionales',linewidth=0.3,color='w')
...
img_plot=bmap.imshow(array_01, origin='upper', cmap=cpt_convert, vmin=0, vmax=24)
...
Unit = "Numero de eventos por dia"    
cb.set_label(Unit)
...
plt.savefig(folder+'frecuencia_d_'+dia+'_'+str(umbral)+'K_r.png', dpi=300,bbox_inches='tight', pad_inches=0)
...
driver.CreateCopy(folder+'frecuencia_d_'+dia+'_'+str(umbral)+'K.tif', grid_minimo, 0)
